...
class WeightedGATConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr=None):
        """"""
        edge_index, edge_attr = add_self_loops_partial(self.device,edge_index, edge_attr)
...
def add_self_loops_partial(device,edge_index, edge_weight=None, fill_value=1., num_nodes=None):
    # print("-------------------------------------------",num_nodes)
    # print(edge_index)
    ...
    loop_weight = torch.full((num_nodes,), fill_value).to(device)  # .cuda()
